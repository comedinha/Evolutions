...
keywordHandler:addKeyword({'addons'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te dar mage, nobleman, warrior, barbarian, druid, wizard, oriental, assassin, shaman, nighmare, jester, yalaharian, warmaster, wayfarer, afflicted, deepling, insectoid, crystal warlord e soil guardian addons.'})
...
local mount_node = keywordHandler:addKeyword({'blazebringer'}, playerBuyMountNPC, {premium = false, cost = 10000, items = {}, mountid = 9, storageID = 10057})
	mount_node:addChildKeywordNode(yesNode)
	mount_node:addChildKeywordNode(noNode)
	
-- Donkey (done)(custom)
local mount_node = keywordHandler:addKeyword({'donkey'}, playerBuyMountNPC, {premium = false, cost = 10000, items = {}, mountid = 13, storageID = 10058})
	mount_node:addChildKeywordNode(yesNode)
	mount_node:addChildKeywordNode(noNode)
...
local mount_node = keywordHandler:addKeyword({'shadow draptor'}, playerBuyMountNPC, {premium = false, cost = 10000, items = {}, mountid = 24, storageID = 10062})
	mount_node:addChildKeywordNode(yesNode)
	mount_node:addChildKeywordNode(noNode)
	
-- Stampor (done)(custom)
local mount_node = keywordHandler:addKeyword({'stampor'}, playerBuyMountNPC, {premium = false, cost = 10000, items = {}, mountid = 11, storageID = 10063})
	mount_node:addChildKeywordNode(yesNode)
	mount_node:addChildKeywordNode(noNode)
	
-- Uniwheel (done)(custom)
local mount_node = keywordHandler:addKeyword({'uniwheel'}, playerBuyMountNPC, {premium = false, cost = 10000, items = {}, mountid = 15, storageID = 10064})
	mount_node:addChildKeywordNode(yesNode)
	mount_node:addChildKeywordNode(noNode)
