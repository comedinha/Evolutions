...
local POTIONS = {
	...
	[7620] = {empty = 7636, splash = 47, mana = {100, 200}}, -- mana potion
	[7589] = {empty = 7634, splash = 47, mana = {200, 400}, level = 50, vocations = {1, 2, 3, 5, 6, 7}, vocStr = "sorcerers, druids and paladins"}, -- strong mana potion
	[7590] = {empty = 7635, splash = 47, mana = {500, 700}, level = 80, vocations = {1, 2, 5, 6}, vocStr = "sorcerers and druids"}, -- great mana potion
