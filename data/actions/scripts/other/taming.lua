...
local config = {
	...
	[13292] =	{NAME = 10065,					ID = 8,		TYPE = TYPE_ACTION,		CHANCE = 40,    FAIL_MSG = { {2, "The key broke inside."} }, SUCCESS_MSG = "You have started the Tin Lizzard!"},
	...
	[13939] = 	{NAME = 'War Horse Black',		ID = 17, 	TYPE = TYPE_MONSTER, 	CHANCE = 15, 	FAIL_MSG = { {1, "The horse runs away."}, {2, "The horse ate the oats."} }, SUCCESS_MSG = "You have tamed the horse."},
	...
	[15546] = 	{NAME = 'Lady Bug', 			ID = 27, 	TYPE = TYPE_MONSTER, 	CHANCE = 40, 	FAIL_MSG = { {1, "The lady bug runs away."}, {2, "The lady bug ate the four leaf clover."} }, SUCCESS_MSG = "You have tamed the lady bug."},
	[15545] = 	{NAME = 'Manta Ray',			ID = 28, 	TYPE = TYPE_MONSTER, 	CHANCE = 40, 	FAIL_MSG = { {1, "The manta runs away."}, {2, "The manta ate the foxtail."} }, SUCCESS_MSG = "You have tamed the manta."},
	[18447] = 	{NAME = 'Ironblight', 			ID = 29, 	TYPE = TYPE_MONSTER, 	CHANCE = 40, 	FAIL_MSG = { {1, "The ironblight runs away."}, {2, "The ironblight ate the iron loadstone."} }, SUCCESS_MSG = "You have tamed the ironblight."},
	[18448] = 	{NAME = 'Magma Crawler', 		ID = 30, 	TYPE = TYPE_MONSTER, 	CHANCE = 40, 	FAIL_MSG = { {1, "The magma crawler runs away."}, {2, "The magma crawler ate the glow wine."} }, SUCCESS_MSG = "You have tamed the magma crawler."},
	[18449] = 	{NAME = 'Dragonling', 			ID = 31, 	TYPE = TYPE_MONSTER, 	CHANCE = 40, 	FAIL_MSG = { {1, "The dragonling runs away."}, {2, "The dragonling ate the decorative ribbon."} }, SUCCESS_MSG = "You have tamed the dragonling."},
	[18516] = 	{NAME = 'Modified Gnarlhound', 	ID = 32, 	TYPE = TYPE_MONSTER, 	CHANCE = 40, 	FAIL_MSG = { {1, "The modified gnarlhound runs away."}, {2, "The modified gnarlhound ate the golem wrench."} }, SUCCESS_MSG = "You have tamed the modified gnarlhound."},
	[20138] = 	{NAME = 'Water Buffalo', 		ID = 35, 	TYPE = TYPE_MONSTER, 	CHANCE = 30, 	FAIL_MSG = { {1, "The water buffalo runs away."}, {2, "The water buffalo is trying to nibble."} }, SUCCESS_MSG = "You have tamed a water buffalo."},
	[21452] = 	{NAME = 'Gravedigger', 			ID = 39, 	TYPE = TYPE_MONSTER, 	CHANCE = 30, 	FAIL_MSG = { {1, "The gravedigger runs away."}, {2, "The gravedigger is trying to nibble."} }, SUCCESS_MSG = "You have tamed a hellgrip."},
	[22608] = 	{NAME = 'Shock Head', 			ID = 42, 	TYPE = TYPE_MONSTER, 	CHANCE = 30, 	FAIL_MSG = { {1, "The shock head runs away."}, {2, "The shock head is trying to nibble."} }, SUCCESS_MSG = "You have tamed a shock head."},
}
