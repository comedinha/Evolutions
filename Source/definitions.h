...
#define CLIENT_VERSION_STRING "Only clients with protocol 9.86 allowed!"
...
#define SOFTWARE_NAME "Alissow Server"
#define SOFTWARE_VERSION "5.0"
#define SOFTWARE_DEVELOPERS "Comedinha, Alissow, TFS Team & CiA"
