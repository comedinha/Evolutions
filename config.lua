-- The Forgotten Server Config
	...
	-- Status
	statusPort = 7171
	ownerName = "Staff Alissow Server"
	ownerEmail = "suporte@sotserv.com"
	url = "http://sotserv.blogspot.com.br/"
	location = "Brazil"
	...
	-- Advanced
	-- gmAnonymousInChannel 0 - Normal; 1 - Help Channel; 2 - All channels
	advertisingBlock = ".net;servegame;no-ip,.net;.com;.com.br;.org;.pl;.net;.biz"
	gmAnonymousInChannel = 0
